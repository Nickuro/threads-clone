  ...
  <div id="CreatePost"
    ...
    <div class="bg-black h-full w-full text-white overflow-auto">
        ...
        <div class="py-2 w-full">
          <div class="flex items-center">
            <div v-if="user"
              ...
              <img class="rounded-full h-[35px]"
                   :src="user.identities[0].identity_data.avatar_url">
              <div class="ml-2 font-semibold text-[18px]">{{ user.identities[0].identity_data.preferred_username }}</div>
            </div>
          </div>
            ...
            <div class="bg-black rounded-lg w-[calc(100%-50px)] text w-full font-light">
              <div class="pt-2 text-gray-300 bg-black w-full">
                <textarea v-model="text"
                          ...
                          class="w-full bg-black outline-none"></textarea>
              </div>
              ...
              <div class="w-full">
                <div class="flex flex-col gap-2 py-1">
                  ...
                  <div v-if="fileDisplay">
                    <img class="mx-auto w-full mt-2 mr-2 rounded-lg"
                         :src="fileDisplay" />
                  </div>

                  <label for="fileInput">
                    <Icon name="clarity:paperclip-line"
                          size="25"
                          color="#ffffff" />
                    <input ref="file"
                           type="file"
      ...
      <button v-if="text"
              :disabled="isLoading"
              @click="createPost"
              class="fixed bottom-0 font-bold text-lg w-full p-2 bg-black inline-block float-right p-4 border border-t border-t-gray-700"
